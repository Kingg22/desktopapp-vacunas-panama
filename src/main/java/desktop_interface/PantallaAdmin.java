...
import logic.user_management.Preferences;
import logic.user_management.User;
...
public class PantallaAdmin extends JFrame {
    ...
    private void initComponents() {
        ...
        StaticMethods.handleFocusGain(jTextField_where, "Condición o condiciones");
        ...
        StaticMethods.handleFocusGain(jTextField_order, "Condición o condiciones");
        ...
        StaticMethods.handleFocusGain(jTextField_group, "Condición o condiciones");
        ...
        StaticMethods.handleFocusGain(jTextField_having, "Condición o condiciones");
        ...
        StaticMethods.handleFocusGain(jTextField_where1, "Condición o condiciones");
        ...
        jButton2.setIcon(new ImageIcon(getClass().getResource("src/main/resources/images/lupa_icon.png")));
        ...
        jButton3.setIcon(new ImageIcon(getClass().getResource("src/main/resources/images/lupa_icon.png")));
        ...
        StaticMethods.handleFocusGain(jTextField_where2, "Condición o condiciones");
        ...
        jButton4.setIcon(new ImageIcon(getClass().getResource("src/main/resources/images/lupa_icon.png")));
        ...
        icon_project
                .setIcon(new ImageIcon(getClass().getResource("src/main/resources/images/operacionVacunas_logo.png")));
    ...
    private void jTextField_buscarTablaFocusGained(FocusEvent evt) {
        StaticMethods.handleFocusGain(jTextField_buscarTabla, "Buscar...");
    }
    ...
    private void jTextField_valorUpdateFocusGained(FocusEvent evt) {
        StaticMethods.handleFocusGain(jTextField_valorUpdate, "Valor");
    }
    ...
    private void jTextField_valorInsertFocusGained(FocusEvent evt) {
        StaticMethods.handleFocusGain(jTextField_valorInsert, "Valor");
    }
    ...
    private void jTextField_valorInsert2FocusGained(FocusEvent evt) {
        StaticMethods.handleFocusGain(jTextField_valorInsert2, "Valor");
    }
    ...
    /* métodos propios */
    public void personalizarVentana(User userActual) {
    ...
    private void addFocusListenerCondicion(JTextField field) {
        field.addFocusListener(new FocusAdapter() {
            @Override
            public void focusGained(FocusEvent evt) {
                StaticMethods.handleFocusGain(field, "Condición o condiciones");
            }
    ...
    private void addFocusListenerValor(JTextField field) {
        field.addFocusListener(new FocusAdapter() {
            @Override
            public void focusGained(FocusEvent evt) {
                StaticMethods.handleFocusGain(field, "Valor");
            }
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(() -> new PantallaAdmin(new User("Rey", "AcostaPruebas", "8-1024-1653",
