 ...
 * @param <R> tipo de dato para la estructura de datos (e.g. data)
 ...
 */
public interface IApiResponse<R, S, T> extends Serializable {
    void addStatus(S code, HttpStatus message);
    ...
    void addError(S code);
    void addWarning(S code, String message);
    void setData(R data);
    R getData();
    void setMetadata(R metadata);
    R getMetadata();
