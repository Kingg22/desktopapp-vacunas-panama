...
public class RegistrarUser extends JFrame {
    ...
    private void addListeners() {
        ...
        PantallaBase.addFocusListeners(jTextField_telefono, "Ingrese su teléfono (código de país, el código de ciudad y el número de teléfono local)");
        ...
        PantallaBase.addActionListeners(jTextField_telefono, jTextField_usuario);
        PantallaBase.addActionListeners(jTextField_usuario, jPasswordField);
    }

    /* métodos static para manejar los focus de los campos */
